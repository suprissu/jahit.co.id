            ...
            <form class="auth-form" method="POST" action="">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="initiation-reject-excuse" placeholder="Masukkan catatan tambahan di sini" type="text" class="form-control" id="initiation-reject-excuse" aria-describedby="noteHelp" rows="3"></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-dismiss="modal">Batal</button>
                    <button type="button" class="btn btn-danger">Tolak Proyek</button>
                </div>
            </form>
        </div>
    </div>
