    ...
    <div class="customerAdminChat__container mb-2 collapse" id="customer-admin-chat">
         <div class="chatbox__container">
                <div class="chatbox__header">
                    <h6 class="chatbox__title">Administrator</h6>
                </div>
                <div class="chatbox__messages tab-content">
                    ...
                    <div class="chatbox__messages__wrapper" id="content-user-13123213">
                        @foreach ( $adminInbox->adminChats->sortByDesc('updated_at') as $chat )
                    ...
                    @else
                        <form action="{{ route('home.inbox.replyAdmin', ['inboxId' => $adminInbox->id]) }}" method="POST">
                    @endif
                            @csrf
                            <input name="message" placeholder="Masukkan pesan anda di sini" type="text" class="form-control">
