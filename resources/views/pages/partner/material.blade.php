...
<div class="userPartnerAddMaterial">
    <div class="userPartnerAddMaterial__container">
        ...
        <div class="userPartnerAddMaterial__addMaterial">
            <form class="auth-form" method="POST" action="{{ 'home.transaction.material.request' }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input placeholder="Masukkan jumlah material yang dibutuhkan" name="quantity" type="text" class="form-control @error('quantity') is-invalid @enderror" value="{{ old('quantity') }}" id="material-amount" aria-describedby="materialHelp" required autocomplete="quantity" autofocus>            
                    @error('quantity')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
