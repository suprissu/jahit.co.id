        ...
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <div class="admin__dashboard__header list-group" id="list-tab" role="tablist">
                        ...
                        <a class="list-group-item list-group-item-action" id="list-inactivepartner-list" data-toggle="list" href="#list-inactivepartner" role="tab" aria-controls="inactivepartner">Inactive Vendors ({{ $waitingPartners->count() }})</a>
                        ...
                        <a class="list-group-item list-group-item-action" id="list-payment-list" data-toggle="list" href="#list-payment" role="tab" aria-controls="payment">Finished Projects ({{ $finishedProjects->count() }})</a>
                </div>
                <div class="admin__dashboard__list header tab-content" id="nav-tabContent">
                            ...
                            <div class="card my-3">
                                <div class="card-body">
                                    <div class="row justify-content-between mx-0">
                                        <h4 class="mb-4">{{ $partner->user->name }}
                                        @if ( $partner->user->is_active == true )
                                         <span><p class="badge badge-success p-2" style="font-size: 12px;">Activated</p></span>
                                        @endif
                                        </h4>
                                        @if ( $partner->user->is_active == true )
                                    ...
                                    @else
                                        <p><strong>Status :</strong><br/> Tidak Aktif</p>
                                    @endif
                                    <p><strong>Rating :</strong><br/> @if ($partner->review_number == 0) - @else {{ $partner->rating / $partner->review_number }} @endif</p>
                                </div>
                                <div class="row m-2">
                                    <div class="col">
                    ...
                    <div class="tab-pane fade" id="list-inactivepartner" role="tabpanel" aria-labelledby="list-inactivepartner-list">
                        @foreach ($waitingPartners as $counter=>$partner)
                            <div class="card my-3">
                                <div class="card-body">
                                    <div class="row justify-content-between mx-0">
                                        <h4 class="mb-4">{{ $partner->user->name }}
                    ...
                    <div class="tab-pane fade" id="list-payment" role="tabpanel" aria-labelledby="list-payment-list">
                        @foreach ($finishedProjects as $index => $project)
                            <div class="card card-body my-3">
                                
                                    <div class="row justify-content-between mx-0">
                                    
                                        <h4 class="mb-4">{{ $project->name }}</h4>
                                        <form action="{{ route('home.administrator.verification.project.pay') }}" method="POST">
                                            @csrf
                                            <input name="projectID" value="{{ $project->id }}" style="display: none;" required>
